...
@bot.on_message(filters.command("write") & ~filters.forwarded)
async def on_off_antiarab(_, message: Message):
    m = await message.reply_text("**✍️ Writing Text ✍️**......\n\n[░░░░░░░░░░] 00%")
    await m.edit("**✍️ Writing Text ✍️**......\n\n[▇▇░░░░░░░░] 20%")
    await m.edit("**✍️ Writing Text ✍️**......\n\n[▇▇▇▇░░░░░░] 40%")
    await m.edit("**✍️ Writing Text ✍️**......\n\n[▇▇▇▇▇░░░░░] 50%")
    await m.edit("**✍️ Writing Text ✍️**......\n\n[▇▇▇▇▇▇▇░░░] 70%")
    await m.edit("**✍️ Writing Text ✍️**......\n\n[▇▇▇▇▇▇▇▇░░] 80%")
    ...
    s=f.replace('/write ' ,'')
    text=s.replace(' ', '%20')
    lol = (f"https://api.single-developers.software?write={text}")
    photo = wget.download(lol, 'pythonlogo.png')
    await m.delete()
    caption = f"""
✍️__**Writed**__  𝐒𝐮𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 ✅
◇───────────────◇
